...
function _isoAt(daysOffset, hour, minute = 0) {
  const d = new Date(_now);
...
const _todayCompact = _localDate(_now).replace(/-/g, '');
...
export const mockPatients = [
  {
    id: '1', file_number: `DP-${_todayCompact}-0001`, name: 'Sarah Johnson',
    ...
    consent_given: true, consent_date: _daysAgoDate(3), consent_method: 'digital',
    notes: 'Prefers morning appointments', created_at: _isoAt(-3, 10, 0)
  },
  {
    id: '2', file_number: `DP-${_todayCompact}-0002`, name: 'James Wilson',
    ...
    consent_given: true, consent_date: _daysAgoDate(19), consent_method: 'written',
    notes: 'Allergic to penicillin', created_at: _isoAt(-19, 14, 30)
  },
  {
    id: '3', file_number: `DP-${_todayCompact}-0003`, name: 'Emily Chen',
    ...
    notes: '', created_at: _isoAt(0, 9, 15)
  },
  {
    id: '4', file_number: `DP-${_todayCompact}-0004`, name: 'Robert Martinez',
    ...
    consent_given: true, consent_date: _daysAgoDate(45), consent_method: 'verbal',
    notes: 'Has dental anxiety, needs extra time', created_at: _isoAt(-45, 11, 0)
  },
  {
    id: '5', file_number: `DP-${_todayCompact}-0005`, name: 'Amanda Davis',
    ...
    consent_given: true, consent_date: _daysAgoDate(3), consent_method: 'digital',
    notes: 'New patient, referred by Dr. Smith', created_at: _isoAt(-3, 16, 45)
  }
];
...
export const mockAppointments = [
  {
    ...
    appointment_date: _daysFromNow(1), appointment_time: '9:00 AM', service_type: 'Cleaning',
    duration_minutes: 60, status: 'scheduled', is_emergency: false,
    notes: 'Regular 6-month cleaning', created_at: _isoAt(-5, 10, 0)
  },
  {
    id: 'a2', patient_id: '2', patient_name: 'James Wilson', patient_phone: '+1-555-0103',
    appointment_date: _daysFromNow(1), appointment_time: '10:30 AM', service_type: 'Root Canal',
    duration_minutes: 90, status: 'scheduled', is_emergency: false,
    notes: 'Follow-up from last visit', created_at: _isoAt(-7, 14, 0)
  },
  {
    id: 'a3', patient_id: '3', patient_name: 'Emily Chen', patient_phone: '+1-555-0105',
    appointment_date: _daysFromNow(1), appointment_time: '2:00 PM', service_type: 'Emergency',
    duration_minutes: 45, status: 'pending_verification', is_emergency: true,
    notes: 'Severe toothache - EMERGENCY', created_at: _isoAt(-1, 22, 0)
  },
  {
    id: 'a4', patient_id: '4', patient_name: 'Robert Martinez', patient_phone: '+1-555-0107',
    appointment_date: _daysFromNow(2), appointment_time: '11:00 AM', service_type: 'Checkup',
    duration_minutes: 30, status: 'pending_verification', is_emergency: false,
    notes: 'Annual checkup', created_at: _isoAt(-2, 9, 0)
  },
  {
    id: 'a5', patient_id: '5', patient_name: 'Amanda Davis', patient_phone: '+1-555-0109',
    appointment_date: _daysFromNow(3), appointment_time: '3:30 PM', service_type: 'Consultation',
    duration_minutes: 45, status: 'scheduled', is_emergency: false,
    notes: 'First visit consultation', created_at: _isoAt(-4, 16, 0)
  }
];
...
export const mockCallLogs = [
  {
    ...
    action_taken: 'Schedule appointment', timestamp: _isoAt(-1, 9, 30),
    start_time: _isoAt(-1, 9, 27), end_time: _isoAt(-1, 9, 30)
  },
  {
    ...
    action_taken: 'Emergency appointment', timestamp: _isoAt(-1, 22, 15),
    start_time: _isoAt(-1, 22, 13), end_time: _isoAt(-1, 22, 15)
  },
  {
    ...
    action_taken: 'Schedule appointment', timestamp: _isoAt(-2, 10, 5),
    start_time: _isoAt(-2, 10, 3), end_time: _isoAt(-2, 10, 5)
  },
  {
    ...
    action_taken: 'inquiry', timestamp: _isoAt(-3, 15, 20),
    start_time: _isoAt(-3, 15, 19), end_time: _isoAt(-3, 15, 20)
  }
];
...
export const mockNotifications = [
  {
    ...
    message: `Emily Chen scheduled an Emergency for ${_daysFromNow(1)} at 2:00 PM`,
    appointment_id: 'a3', patient_id: '3', patient_name: 'Emily Chen',
    status: 'unread', created_at: _isoAt(-1, 22, 15),
    metadata: { phone: '+1-555-0105', service: 'Emergency', date: _daysFromNow(1), time: '2:00 PM', is_emergency: true }
  },
  {
    id: 'n2', type: 'appointment_pending', title: 'New Appointment Needs Verification',
    message: `Robert Martinez scheduled a Checkup for ${_daysFromNow(2)} at 11:00 AM`,
    appointment_id: 'a4', patient_id: '4', patient_name: 'Robert Martinez',
    status: 'unread', created_at: _isoAt(-2, 10, 5),
    metadata: { phone: '+1-555-0107', service: 'Checkup', date: _daysFromNow(2), time: '11:00 AM', is_emergency: false }
  }
];
