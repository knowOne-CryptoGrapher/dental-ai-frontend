  ...
  const openProviderDialog = (provider = null) => {
    if (provider) {
      setForm({
        ...provider,
        location_ids:
          provider.location_ids || (provider.location_id ? [provider.location_id] : []),
        appointment_types:
          provider.appointment_types || ['Cleaning', 'Checkup', 'Consultation'],
        working_hours:
        ...
        <Card className="border-amber-200/80 bg-amber-50/50 max-w-md">
          <CardContent className="p-6 text-center">
            ...
            <p className="text-sm text-gray-600">
              Only practice administrators can manage locations, providers, and team
              members.
            </p>
          </CardContent>
        </Card>
    ...
    <div className="space-y-6 max-w-6xl">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">
          Locations, providers, and team members
        </p>
      </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <div className="grid gap-3">
            {locations.length === 0 ? (
              ...
              locations.map((loc) => (
                <Card
                  key={loc.id}
                  className="border-gray-200/80 hover:shadow-sm transition-shadow"
                >
        ...
        <TabsContent value="providers" className="space-y-4">
          <div className="flex items-center justify-between">
            <p className="text-sm text-gray-600">
              {providers.length} active provider
                        ...
                        <div className="flex items-start gap-3 flex-1">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="space-y-0.5 text-xs text-gray-500">
                              ...
                              {prov.license_number && (
                                <p>License: {prov.license_number}</p>
                              )}
                              {prov.specialties &&
      ...
      >
        <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>{editingItem ? 'Edit' : 'Add'} Provider</DialogTitle>
          </DialogHeader>
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between p-3 border rounded-lg bg-amber-50">
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-600 mt-0.5">
                  Emergency appointments will prioritize this provider
                </p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  ...
                  onChange={(e) =>
                    setForm({ ...form, on_call: e.target.checked })
                  }
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1.5">
                ...
                <Input
                  value={form.itrans_provider_number || ''}
                  onChange={(e) =>
                    setForm({
                      ...form,
                      itrans_provider_number: e.target.value,
                    })
                  }
